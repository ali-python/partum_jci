...
from common.philip_stock_logs import PhilipDailyStockLogs, PhilipMonthlyStockLogs
...
urlpatterns = [
    ...
    path('philip/logs/daily', PhilipDailyStockLogs.as_view(), name='philip_daily_logs'),
	path('philip/logs/monthly', PhilipMonthlyStockLogs.as_view(), name='philip_monthly_logs'),
]
