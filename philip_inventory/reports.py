...
from philip_inventory.models import Invoice, Customer, Expense, CustomerLedger,CarPartsInvoice, CarPartsStockOut
...
class MonthlyReports(TemplateView):
    template_name = 'philip_inventory/monthly_reports.html'
