...
# from japan_inventory.models import CarBrand, StockIn, StockOut, Expense, Employee, CarBuyPart, Customer, Invoice, \
#     CustomerLedger
#
#
...
#     list_display = (
#         '__str__', 'customer', 'payment_type', 'bill_no', 'total_quantity', 'sub_total', 'paid_amount',
#         'remaining_payment',
