...
class AddCarBrand(FormView):
    ...
    def form_valid(self, form):
        form.save()
        return HttpResponseRedirect(reverse('philip_inventory:list_car_brand'))
...
class DeleteCarBrand(DeleteView):
    model = CarBrand
    success_url = reverse_lazy('philip_inventory:list_car_brand')
    success_message = ''
...
class DeleteCarStock(DeleteView):
    model = StockIn
    success_url = reverse_lazy('philip_inventory:car_stock_list')
    success_message = ''
...
class DeleteCarPartsStock(DeleteView):
    model = CarBuyPart
    success_url = reverse_lazy('philip_inventory:list_car_parts')
    success_message = ''
