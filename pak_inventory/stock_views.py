...
class AddCarBrand(FormView):
    ...
    template_name = 'pak_inventory/carbrand/add_car_brand.html'
    ...
    def form_valid(self, form):
        form.save()
        return HttpResponseRedirect(reverse('pak_inventory:list_car_brand'))
...
class CarBrandList(ListView):
    model = CarBrand
    template_name = 'pak_inventory/carbrand/list_car_brand.html'
    paginate_by = 100
    ordering = 'brand_name'
...
class DeleteCarBrand(DeleteView):
    model = CarBrand
    success_url = reverse_lazy('pak_inventory:list_car_brand')
    success_message = ''
...
class AddCarStock(FormView):
    ...
    template_name = 'pak_inventory/stock/add_stock.html'
    ...
    def form_valid(self, form):
        form.save()
        return HttpResponseRedirect(reverse('pak_inventory:car_stock_list'))
...
class CarStockList(ListView):
    model = CarBrand
    template_name = 'pak_inventory/stock/stock_list.html'
    paginate_by = 100
    ordering = 'car_brand'
...
class DeleteCarStock(DeleteView):
    model = StockIn
    success_url = reverse_lazy('pak_inventory:car_stock_list')
    success_message = ''
...
class UpdateCarStockIn(UpdateView):
    model = StockIn
    form_class = StockInForm
    template_name = 'pak_inventory/stock/update_stockin.html'
...
class AddCarParts(FormView):
    ...
    template_name = 'pak_inventory/stock/add_car_parts_stock.html'
    ...
    def form_valid(self, form):
        ...
        obj.status = 'True'
        obj.save()
        return HttpResponseRedirect(reverse('pak_inventory:list_car_parts'))
...
class CarPartsList(ListView):
    model = CarBuyPart
    template_name = 'pak_inventory/stock/car_parts_list.html'
    paginate_by = 100
...
class DeleteCarPartsStock(DeleteView):
    model = CarBuyPart
    success_url = reverse_lazy('pak_inventory:list_car_parts')
    success_message = ''
