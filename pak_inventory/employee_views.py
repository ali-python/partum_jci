...
from pak_inventory.forms import EmployeeFormView, EmployeeSalaryForm
from pak_inventory.models import Employee, EmployeeSalary
...
class EmployeeList(ListView):
    template_name = 'pak_inventory/employee/employee_list.html'
    model = Employee
    paginate_by = 100
    ordering = 'name'
...
class EmployeeSalaryFormView(FormView):
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(
            reverse('pak_inventory:employee_salary_detail',
...
class DeleteEmployeeSalary(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        obj = self.get_object()
        success_url = reverse_lazy('pak_inventory:employee_salary_detail', kwargs={
                                   'pk': obj.employee.id})
        obj.delete()
