    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cash_returned', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=65, null=True)),
                ('date', models.DateField(blank=True, default=django.utils.timezone.now, null=True)),
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='customer_sales', to='pak_inventory.customer')),
            ],
        ),
        migrations.CreateModel(
            name='StockIn',
            fields=[
                ...
                ('car_brand', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='car_brand_name', to='pak_inventory.carbrand')),
            ],
        ),
        migrations.CreateModel(
            name='StockOut',
            fields=[
                ...
                ('dated', models.DateField(blank=True, default=django.utils.timezone.now, null=True)),
                ('car', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='car_stockout', to='pak_inventory.stockin')),
                ('invoice', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='invoice_stockout', to='pak_inventory.invoice')),
            ],
        ),
        migrations.CreateModel(
            name='EmployeeSalary',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(blank=True, default=django.utils.timezone.now, null=True)),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customer_ledger', to='pak_inventory.customer')),
                ('invoice', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='invoice_ledger', to='pak_inventory.invoice')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dated', models.DateField(blank=True, default=django.utils.timezone.now, null=True)),
                ('car_parts', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='car_parts_stockout', to='pak_inventory.carbuypart')),
                ('invoice', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='invoice_car_parts_stockout', to='pak_inventory.carpartsinvoice')),
            ],
        ),
        migrations.AddField(
            model_name='carpartsinvoice',
            name='customer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='customer_sales_car_parts', to='pak_inventory.customer'),
        ),
        migrations.CreateModel(
            name='BankLedger',
            fields=[
                ...
                ('details', models.TextField(blank=True, max_length=500, null=True)),
                ('date', models.DateField(blank=True, default=django.utils.timezone.now, null=True)),
                ('bank', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bank_ledger', to='pak_inventory.bank')),
            ],
        ),
    ]
