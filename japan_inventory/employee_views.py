...
from japan_inventory.forms import EmployeeFormView, EmployeeSalaryForm
from japan_inventory.models import Employee, EmployeeSalary
...
class AddEmployee(FormView):
    ...
    def form_valid(self, form):
       form.save()
       return HttpResponseRedirect(reverse('japan_inventory:employee_list'))
...
class EmployeeSalaryFormView(FormView):
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(
            reverse('japan_inventory:employee_salary_detail',
...
class DeleteEmployeeSalary(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        obj = self.get_object()
        success_url = reverse_lazy('japan_inventory:employee_salary_detail', kwargs={
                                   'pk': obj.employee.id})
        obj.delete()
